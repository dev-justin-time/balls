export const BALL_DB = {
  ...
  diamond: { name: 'Diamond', price: 1000, tex: 'assets/image/ball_metal.webp', type: 'texture', ability: { key: 'coins', base: 1.2, perLevel: 0.12 }, description: 'Premium reflective diamond skin.' },
  obsidian: { name: 'Obsidian', price: 1500, tex: 'assets/image/ball_lava.webp', type: 'texture', ability: { key: 'jump', base: 1.15, perLevel: 0.08 }, description: 'Dark obsidian with strong jump ability.' },
  galaxy: { name: 'Galaxy', price: 2000, tex: 'assets/image/dsfk.webp', type: 'texture', ability: { key: 'speed', base: 1.12, perLevel: 0.08 }, description: 'Shifting galaxy pattern with speed bonus.' },
  golden: { name: 'Golden', price: 5000, tex: 'assets/image/ball_metal.webp', type: 'texture', ability: { key: 'coins', base: 1.35, perLevel: 0.14 }, description: 'High-value golden skin boosting coin gain.' },
  ember: { name: 'Ember', price: 180, tex: 'assets/image/ball_lava.webp', type: 'texture', ability: { key: 'jump', base: 1.03, perLevel: 0.06 }, description: 'Hot ember texture with small jump bonus.' },
  polished: { name: 'Polished', price: 200, tex: 'assets/image/ball_metal.webp', type: 'texture', ability: { key: 'speed', base: 1.04, perLevel: 0.05 }, description: 'Smooth polished metal skin.' },
  oak: { name: 'Oak', price: 60, tex: 'assets/image/wood_texture.webp', type: 'texture', ability: { key: 'jump', base: 1.01, perLevel: 0.04 }, description: 'Simple oak finish.' },
  ...
  mosaic: { name: 'Mosaic', price: 350, tex: 'assets/image/dsfk.webp', type: 'texture', ability: { key: 'speed', base: 1.05, perLevel: 0.06 }, description: 'Colorful mosaic.' },
  marble: { name: 'Marble', price: 190, tex: 'assets/image/ball_metal.webp', type: 'texture', ability: { key: 'jump', base: 1.04, perLevel: 0.05 }, description: 'Marbled skin.' },
  citrus: { name: 'Citrus', price: 75, tex: 'assets/image/Basketball.webp', type: 'texture', ability: { key: 'coins', base: 1.01, perLevel: 0.03 }, description: 'Bright citrus theme.' },
  cobalt: { name: 'Cobalt', price: 130, tex: 'assets/image/bolos.webp', type: 'texture', ability: { key: 'speed', base: 1.03, perLevel: 0.04 }, description: 'Deep blue cobalt.' },
  graphite: { name: 'Graphite', price: 300, tex: 'assets/image/ball_metal.webp', type: 'texture', ability: { key: 'coins', base: 1.06, perLevel: 0.06 }, description: 'Dark graphite finish.' },
  ember_core: { name: 'Ember Core', price: 450, tex: 'assets/image/ball_lava.webp', type: 'texture', ability: { key: 'jump', base: 1.06, perLevel: 0.07 }, description: 'Core ember variant.' },
  prism: { name: 'Prism', price: 380, tex: 'assets/image/dsfk.webp', type: 'texture', ability: { key: 'coins', base: 1.07, perLevel: 0.06 }, description: 'Prismatic reflections.' },
  driftwood: { name: 'Driftwood', price: 95, tex: 'assets/image/wood_texture.webp', type: 'texture', ability: { key: 'jump', base: 1.02, perLevel: 0.04 }, description: 'Weathered driftwood.' },
  chrome_stripe: { name: 'Chrome Stripe', price: 240, tex: 'assets/image/ball_metal.webp', type: 'texture', ability: { key: 'speed', base: 1.05, perLevel: 0.06 }, description: 'Striped chrome.' },
  lava_flow: { name: 'Lava Flow', price: 320, tex: 'assets/image/ball_lava.webp', type: 'texture', ability: { key: 'coins', base: 1.09, perLevel: 0.07 }, description: 'Flowing lava texture.' },
  ...
  sunmetal: { name: 'Sunmetal', price: 520, tex: 'assets/image/ball_metal.webp', type: 'texture', ability: { key: 'speed', base: 1.08, perLevel: 0.07 }, description: 'Sunlit metal.' },
  magma_core: { name: 'Magma Core', price: 700, tex: 'assets/image/ball_lava.webp', type: 'texture', ability: { key: 'coins', base: 1.15, perLevel: 0.09 }, description: 'Magma core powerful coin skin.' },
  coral: { name: 'Coral', price: 85, tex: 'assets/image/Basketball.webp', type: 'texture', ability: { key: 'jump', base: 1.01, perLevel: 0.03 }, description: 'Coral texture.' },
  sapphire: { name: 'Sapphire', price: 420, tex: 'assets/image/bolos.webp', type: 'texture', ability: { key: 'coins', base: 1.1, perLevel: 0.07 }, description: 'Sapphire toned skin.' },
  voidglass: { name: 'Voidglass', price: 980, tex: 'assets/image/dsfk.webp', type: 'texture', ability: { key: 'speed', base: 1.12, perLevel: 0.08 }, description: 'Void-like glass skin.' },
