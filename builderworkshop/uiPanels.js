// uiPanels.js
import { selection, setMode, toggleSticky, selectAll, selectNone } from "./selection.js";
import { applySculptTool, applySmoothTool } from "./sculpting.js";
import { hollowOut, patchHole } from "./modifiers.js";
import { uploadBoneData, downloadBoneData, startGenerativeTask } from "./rigging.js";
...
export function initUIPanels() {
    ...
    // In a real app, you'd hook this into your main pointerdown/move loop
    ...
    rigPanel.querySelectorAll('.slot').forEach(slotEl => {
        ...
        slotEl.querySelector('.up').onclick = () => {
            ...
            input.onchange = (e) => uploadBoneData(slotId, e.target.files[0]);
            input.click();
        };
